...
class CQuestion
{
    ...
    public function showallintheme($pdo, $twig)
    {
        ...
        if (isset($_GET['themeid'])) {
            ...
            $params = array(
                'content' => 'question_all_in_theme.html.twig',
                'questions' => $questions,
    ...
    public function showall($pdo, $twig)
    {
        $admin = new Admin();
        if (!$admin->isLogedin($pdo)) header('Location: index.php?contr=admin&act=login');
        $template = $twig->loadTemplate('admin_header.html.twig');
        $params = array();
        $template->display($params);
        ...
        foreach ($themes as $theme) {
            $themeId = $theme->getId();
            $questions = Question::getAllQuestions($themeId,$pdo);
            $template = $twig->loadTemplate('question_all_in_theme.html.twig');
            $params = array(
                'questions' => $questions,
                'currentTheme' => $theme
            );
        ...
        $template = $twig->loadTemplate('admin_footer.html.twig');
        $params = array();
        $template->display($params);    
    }
    ...
    public function showpublished($pdo, $twig)
    {
        if (isset($_GET['themeid'])) {
            ...
            $params = array(
                'content' => 'question_published.html.twig',
                'questions' => $questions,
                'currentTheme' => $currentTheme,
                'themes' => $themes
            );
    ...
    public function showallunanswered($pdo, $twig)
    {
        ...
        $template = $twig->loadTemplate('admin.html.twig');
        $params = array(
            'content' => 'question_all_unanswered.html.twig',
            'questions' => $questions,
        );
        $template->display($params);    
    }
    ...
    public function answer($pdo, $twig)
    {
        ...
        if (isset($_GET['questionid'])){
            ...
            $template = $twig->loadTemplate('admin.html.twig');
            $params = array(
                'content' => 'question_answer.html.twig',
                'question' => $question
            );
            $template->display($params);
        }
    ...
    public function edit($pdo, $twig)
    {
        ...
        if (isset($_GET['questionid'])){
            ...
            $template = $twig->loadTemplate('admin.html.twig');
            $params = array(
                'content' => 'question_edit.html.twig',
                'question' => $question
            );
            $template->display($params);
        }
    ...
    public function move($pdo, $twig)
    {
        ...
        if (isset($_GET['questionid'])){
            ...
            $template = $twig->loadTemplate('admin.html.twig');
            $params = array(
                'content' => 'question_move.html.twig',
                'question' => $question,
                'currentTheme' => $currentTheme,
                'themes' => $themes
            );
